...
const APP_DATA = {
  ...
  joshi: {
    ...
    advanced: [
      { sentence: 'わたし（　）あさごはんをたべた。', hint: 'だれがするかを表す助詞', answer: 'は' },
      { sentence: 'えんぴつ（　）ちらかっている。', hint: '存在を表す助詞', answer: 'が' },
      { sentence: 'かばん（　）もちなさい。', hint: 'どれを、という助詞', answer: 'を' },
      { sentence: 'ともだち（　）あそんだ。', hint: '一緒にを表す助詞', answer: 'と' },
      { sentence: 'がっこう（　）いきます。', hint: '場所・方向を表す助詞', answer: 'に' },
      { sentence: 'おかあさん（　）おかしをもらった。', hint: '相手・起点を表す助詞', answer: 'から' },
      { sentence: 'こうえん（　）サッカーをした。', hint: '場所を表す助詞', answer: 'で' },
      { sentence: 'バス（　）がっこうにくる。', hint: '手段を表す助詞', answer: 'で' },
      { sentence: 'たなか先生（　）やさしい。', hint: 'テーマを表す助詞', answer: 'は' },
      { sentence: 'むこう（　）やまがある。', hint: '場所の存在を表す助詞', answer: 'に' },
    ],
  },
  ...
  seikatsu: {
    ...
    words: [
      ...
      { word: 'ぱんつ',  emoji: '🩲', category: '身の回り' },
      { word: 'ずぼん',  emoji: '👖', category: '身の回り' },
